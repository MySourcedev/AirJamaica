    ...
    <div class="container py-4">
        ...
        <nav class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">AJVAC Pilot Center</a></li>
                <li class="breadcrumb-item active">Playton Clarke</li>
            </ol>
        </nav>
        ...
        <div class="profile-card p-4 mb-4">
            <div class="d-flex align-items-center mb-4">
                <div class="position-relative me-4">
                    <img src="https://via.placeholder.com/100" class="rounded-circle border border-secondary" width="90" alt="Pilot Avatar">
                    <span class="position-absolute bottom-0 end-0 bg-success rounded-circle p-1 border border-2 border-dark"></span>
                </div>
                <div>
                    <h2 class="mb-1">Playton Clarke</h2>
        ...
        <div class="profile-card p-4 mb-4">
            ...
            <a href="#" class="request-link completed">
                <span class="status"></span>
                ...
                <div class="profile-card p-4 mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="text-value">AJM1167</p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <p class="text-label mb-1">LOCATION</p>
                            <p class="text-value">United States</p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <p class="text-label mb-1">DATE JOINED</p>
                            <p class="text-value">26th March 2015</p>
                        </div>
                        <div class="col-md-6 mb-3">
            ...
            <div class="tab-pane fade" id="actions">
                <div class="profile-card p-4">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="#" class="btn btn-ghost flex-grow-1">
