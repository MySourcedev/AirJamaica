...
<div class="profile-card p-4 p-md-5">
    ...
    <form id="profileForm" method="post" action="{{ route('user.update', ["user" => Auth::id()]) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <!-- Avatar Section -->
        <div class="text-center mb-5">
            <div class="avatar-container">
                <img src="https://ui-avatars.com/api/?name=C+C&background=333&color=fff" 
                     ...
                     id="avatarPreview">
                <button type="button" class="avatar-upload-btn" id="avatarUploadBtn">
                    <i class="fas fa-camera"></i>
                    <input name="Avatar" type="file" id="avatarInput" class="file-input" accept="image/*">
                </button>
            </div>
            @error('Avatar')
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control readonly-field" value="{{ $user->f_name.' '.$user->l_name }}" readonly>
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control readonly-field" value="{{ $user->airline }}" readonly>
            <div class="admin-note">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                ...
                <select name="location" class="form-select @error('location') is-invalid @enderror" id="location" required>
                    @foreach (["United States", "Canada", "United Kingdom", "Jamaica"] as $country)
                        <option value="{{ $country }}" {{ old('location', $user->location) == $country ? 'selected' : '' }}>
                            {{ $country }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                <input name="VATSIM_ID" type="text" class="form-control @error('VATSIM_ID') is-invalid @enderror" 
                       id="VATSIM_ID" value="{{ old('VATSIM_ID', $user->VATSIM_ID) }}" required>
                @error("VATSIM_ID")
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6 mb-4">
                <label for="background" class="form-label">Signature Background</label>
                <div class="input-group">
                    <input name="Background" type="file" class="form-control @error('Background') is-invalid @enderror" 
