...
<body>
    ...
    <div class="mb-3">
        ...
        <input name="f_name" type="text" class="form-control @error('f_name') is-invalid @enderror" id="firstName" required value="{{ old('f_name') }}">
        @error('f_name')
    ...
    <div class="mb-3">
        ...
        <input name="l_name" type="text" class="form-control @error('l_name') is-invalid @enderror" id="lastName" required value="{{ old('l_name') }}">
        @error('l_name')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input name="confirm_password" type="password" class="form-control @error('confirm_password') is-invalid @enderror" id="confirmPassword">
    ...
    <div class="mb-3">
        ...
        <select name="airline" class="form-select @error('airline') is-invalid @enderror" id="airline" required>
            <option value="AJM" {{ old('airline') == 'AJM' ? 'selected' : '' }}>AJM - Air Jamaica</option>
        </select>
        @error('airline')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    ...
    <div class="mb-3">
        ...
        <select name="hub" class="form-select @error('hub') is-invalid @enderror" id="hub" required>
            <option value="MKJP" {{ old('hub') == 'MKJP' ? 'selected' : '' }}>MKJP - Norman Manley International</option>
        </select>
        @error('hub')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    ...
    <div class="mb-3">
        ...
        <select name="location" class="form-select @error('location') is-invalid @enderror" id="location" required>
    ...
    <div class="mb-3">
        ...
        <input name="VATSIM_ID" type="text" class="form-control @error('VATSIM_ID') is-invalid @enderror" id="VATSIM_ID" required value="{{ old('VATSIM_ID') }}">
        @error('VATSIM_ID')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="mb-3 form-check">
        <input type="checkbox" name="terms" class="form-check-input @error('terms') is-invalid @enderror" id="terms" required {{ old('terms') ? 'checked' : '' }}>
